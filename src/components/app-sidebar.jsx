...
const fullNavMain = [
  ...
  { title: "Order Management", url: "/orderManagement", icon: IconChartBar },
  { title: "Return & Refund Management", url: "/return&refund", icon: IconUsers },
  { title: "Offer & Highlights", url: "/offer&highlights", icon: IconFolder },
  { title: "Analytics", url: "/analytics", icon: IconUsers },
  { title: "Customer Management", url: "/customerManagement", icon: IconUsers },
  { title: "Coupan Management", url: "/coupanManagement", icon: IconUsers },
  { title: "Admin Management", url: "/adminManagement", icon: IconUsers },
];
